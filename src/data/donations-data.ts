...
export const donationMethods: StaticDonationMethod[] = [
  ...
  },
  {
    ...
    contact: 'sonsofmalachie4@gmail.com',
    holder: 'Denis Descartes Tadum',
    instructions: {
      fr: 'Envoyez votre don via PayPal à sonsofmalachie4@gmail.com avec la mention "Don CIFM4".',
      en: 'Send your gift via PayPal to sonsofmalachie4@gmail.com with the note "CIFM4 Donation".',
    },
    copyValue: 'sonsofmalachie4@gmail.com',
    isActive: true,
    order: 3,
  },
  {
