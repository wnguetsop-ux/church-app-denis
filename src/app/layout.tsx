...
export const metadata: Metadata = {
  ...
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_APP_URL ?? 'https://churchdenis.vercel.app'
  ),
  openGraph: {
    ...
    url: process.env.NEXT_PUBLIC_APP_URL ?? 'https://churchdenis.vercel.app',
    siteName: 'CIFM4',
    locale: 'fr_FR',
    type: 'website',
    images: [{ url: '/og-image.jpg', width: 1200, height: 630, alt: 'CIFM4 — Communauté Internationale des Fils de Malachie 4' }],
  },
  twitter: {
