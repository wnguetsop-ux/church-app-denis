...
function HomeContent() {
  ...
  return (
    <div className="space-y-0">
      ...
      {/* Dernier sermon */}
      <AnimatedSection id="dernier-message" className="px-4 py-10 max-w-2xl mx-auto">
        ...
        <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
          <div className="aspect-video bg-gray-100 overflow-hidden flex items-center justify-center">
            <p className="text-gray-400 text-sm">{t('messages.video_coming')}</p>
          </div>
          <div className="p-4 space-y-1">
            <p className="font-semibold text-gray-900">{locale === 'fr' ? '[Titre du sermon]' : '[Sermon title]'}</p>
